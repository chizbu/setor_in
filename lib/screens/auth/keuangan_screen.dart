              ...
              children: [
                _buildMenuTile(
                  ...
                  onTap: () => Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (_) =>
                            const MetodePembayaranScreen(isTransfer: false)),
                  ),
                ),
                _buildMenuTile(
...
// ══════════════════════════════════════════════
//  TRANSFER SCREEN — Kontak HP + Input Manual
// ══════════════════════════════════════════════
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text('Ditransfer ke $metode',
                          style: TextStyle(
                              fontSize: 13, color: Colors.grey.shade600)),
                      Text(_maskName(namaPenerima),
                          style: TextStyle(
                              fontSize: 13, color: Colors.grey.shade600)),
                      const SizedBox(height: 4),
                      Text(tanggal,
            ...
            Row(
              ...
              children: [
                _actionBtn(Icons.share_outlined, () {
                  ScaffoldMessenger.of(context).showSnackBar(_snack('Berbagi struk...'));
                }),
                const SizedBox(width: 16),
                _actionBtn(Icons.download_outlined, () {
                  ScaffoldMessenger.of(context).showSnackBar(_snack('Mengunduh struk...'));
                }),
              ],
            ),
            const SizedBox(height: 32),
...
PreferredSizeWidget _buildAppBar(String title,
    {required bool showBack, required BuildContext context}) {
  return AppBar(
    backgroundColor: Colors.white,
    elevation: 0,
    leading: showBack
