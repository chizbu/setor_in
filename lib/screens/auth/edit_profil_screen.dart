...
class _EditProfilScreenState extends State<EditProfilScreen> {
  ...
  // ✅ Buat instance ImagePicker sekali saja
  ...
  void initState() {
    ...
    _noTelponController =
        TextEditingController(text: widget.userData.noTelpon);
  ...
  // ✅ Satu fungsi untuk kamera dan galeri
