...
class _CekBankSampahScreenState extends State<CekBankSampahScreen>
  ...
  final List<String> _jenisFilter = [
    'Semua', 'Plastik', 'Kertas', 'Logam', 'Kaca', 'Elektronik', 'Organik'
  ];
                  ...
                  Container(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintStyle:
                            const TextStyle(color: kTextSoft, fontSize: 13),
                        prefixIcon:
          ...
          return Positioned(
            ...
            child: GestureDetector(
              ...
              child: Column(children: [
                ...
                CustomPaint(
                  painter:
                      _PinTailPainter(b.buka ? b.markerColor : Colors.grey),
        ...
        Positioned(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                    color: kInfo.withValues(alpha: 0.4),
                    blurRadius: 10,
                    spreadRadius: 4)
              ],
            ),
    ...
    return Container(
      ...
      child: Row(mainAxisSize: MainAxisSize.min, children: [
        Container(
          ...
          height: 6,
          decoration: BoxDecoration(
              color: buka ? kPrimary : kDanger, shape: BoxShape.circle),
        ),
        const SizedBox(width: 4),
        Text(buka ? 'Buka' : 'Tutup',
            style: TextStyle(
                color: buka ? kPrimary : kDanger,
                fontSize: 11,
                fontWeight: FontWeight.w700)),
      ]),
    );
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Row(children: [
                        Expanded(
                            child: _infoBox(Icons.location_on_outlined,
                                'Jarak', b.jarak, kPrimary)),
                        const SizedBox(width: 10),
                        Expanded(
                      ...
                      Container(
                        ...
                        child: Column(children: [
                          _detailRow(Icons.access_time_rounded,
                              'Jam Operasional', b.jamOperasional),
...
class _MapGridPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawLine(Offset(0, size.height * 0.55),
        Offset(size.width, size.height * 0.55), roadH);
    canvas.drawLine(
    ...
    canvas.drawLine(Offset(size.width * 0.35, 0),
        Offset(size.width * 0.35, size.height), roadV);
    canvas.drawLine(
    ...
    canvas.drawRRect(
        RRect.fromRectAndRadius(
            Rect.fromLTWH(size.width * 0.7, size.height * 0.38,
                size.width * 0.25, size.height * 0.22),
            const Radius.circular(4)),
        blockPaint);
    canvas.drawRRect(
        RRect.fromRectAndRadius(
            Rect.fromLTWH(size.width * 0.05, size.height * 0.65,
